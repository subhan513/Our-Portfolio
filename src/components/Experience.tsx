          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              <div key={exp.title} className="relative flex items-start">
                {/* Timeline dot */}
                <div className="hidden md:flex absolute left-6 w-5 h-5 bg-gradient-to-r from-primary to-accent rounded-full border-4 border-border z-10 shadow-lg"></div>
                
                <div className="md:ml-16 w-full">
                  <div className="glass-panel rounded-2xl p-8 hover:border-primary/50 transition-all duration-300 shadow-xl">
